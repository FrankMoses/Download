...
if("undefined" == typeof (clipconverter)) {
	var clipconverter = {
        ...
        userUrl: 'http://www.clipconverter.cc/?ref=addon&version=141&browser=userscript',
        saveUrl: 'http://www.clipconverter.cc/addonsave?version=141&browser=userscript',
        ...
        check: function() {
            if(clipconverter.currentMediaUrl != document.URL && ytplayer && ytplayer.config &&  ytplayer.config.args && clipconverter.currentId != ytplayer.config.args.video_id) { 
                      // new video detected
